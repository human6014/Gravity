...
public class NonInteractableReload : MonoBehaviour, IReloadable
{
    ...
    public bool GetIsNonEmptyReloading() => m_IsReloading;
    ...
    private IEnumerator Reload(WeaponSoundScriptable.DelaySoundClip[] ReloadSoundClip)
    {
